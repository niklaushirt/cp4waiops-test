...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------------------"
#  CP4WAIOPS v3.4.0 - CP4WAIOPS Installation
#
#
...
echo "*****************************************************************************************************************************"
echo "  "
echo "  🐥 CloudPak for Watson AIOps v3.4.0 - Easy Install"
echo "  "
echo "*****************************************************************************************************************************"
echo "*****************************************************************************************************************************"
echo "*****************************************************************************************************************************"
...
menu_EASY_03 () {
      echo "--------------------------------------------------------------------------------------------"
      echo " 🚀  AI Manager create and run Training" 
      echo "--------------------------------------------------------------------------------------------"
      echo ""
      if [[ $WAIOPS_PODS -gt $WAIOPS_PODS_MIN ]]; then
            cd ansible
            ansible-playbook 03_aimanager-training.yaml
            cd -
      else
...
menu_EASY_02 () {
      echo "--------------------------------------------------------------------------------------------"
      echo " 🚀  AI Manager create Topology and Runbooks" 
      echo "--------------------------------------------------------------------------------------------"
      echo ""

      if [[ $WAIOPS_PODS -gt $WAIOPS_PODS_MIN ]]; then
            cd ansible
            ansible-playbook 02_aimanager-topology_runbooks.yaml
            cd -
            echo "*****************************************************************************************************************************"
            echo "*****************************************************************************************************************************"
            echo "*****************************************************************************************************************************"
...
echo "${NC}"
      ...
      if [[ $WAIOPS_PODS -lt $WAIOPS_PODS_MIN ]]; then
            echo "     🚀  ${BYellow}00  - Install AI Manager Demo${NC}   ${Green}<-- Start here${NC}                - Install Complete AI Manager Demo"
      else
      ...
      echo "  📥 ${UBlue}CP4WAIOPS - Guided Install${NC}"

      if [[ $WAIOPS_PODS -lt $WAIOPS_PODS_MIN ]]; then
            echo "         01  - Step 1: Install Base AI Manager                         - Install Vanilla AI Manager"
      else
      ...
      if [[ $SHOW_MORE == "true" ]]; then
            ...
            echo "  "
            echo "  🐥 ${UBlue}CP4WAIOPS Addons${NC}"
            if [[  $DEMOUI_READY == "" ]]; then
            ...
            if [[  $ELK_NAMESPACE == "" ]]; then
                  ...
                  #       echo "    	25  - Install OpenShift Logging                               - Install OpenShift Logging (ELK)"
            echo "  "
            echo "  🐥 ${UBlue}Demo Configuration${NC}"
            ...
            echo "  "
            echo "  🐥 ${UBlue}Ansible AWX - WAIOPS Installer${NC}"
            if [[  $AWX_NAMESPACE == "" ]]; then
